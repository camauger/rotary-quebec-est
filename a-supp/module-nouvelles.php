                        ...
                        while($row_nouvelle=mysql_fetch_object($res_nouvelles))
                            {
                                 ...
                                 {    $testAucune++;
                                      ...
                                      //On affiche le titre et le résué de la nouvelle 
                                          echo "<h4 >".date("d m Y",$row_nouvelle->datecreation)." - ".$row_nouvelle->titre."</h4>";
                                          echo '' .stripslashes($row_nouvelle->resume). '<p class="voirPlus"><a href="/fr/activites/_bulletinChoix.php?
                                        ...
                                        if(date("Y-m", $row_nouvelle->datecreation)==$_POST["annee"]."-".(strlen($_POST["Mois"] )==1?"0".$_POST["Mois"]:$_POST["Mois"]))
                                         { $testAucune++;
                                               if($titre=="")
                                                 ...
                                                 //On décale le contenu
                                                 echo '<div class="boite_texteBulletin">';
                                                  echo "<h4>".date("Y-m-d",$row_nouvelle->datecreation)." - ".$row_nouvelle->titre."</h4>";
